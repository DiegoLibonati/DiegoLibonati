...
<div width="100%">
  ...
  <div>
    <span>🛠️</span>
    <span><a href="https://github.com/DiegoLibonati/node-express-boilerplate">Node Express Boilerplate</a></span>
  ...
  <div>
    <span>🛠️</span>
    <span><a href="https://github.com/DiegoLibonati/react-vite-boilerplate">React Vite Boilerplate</a></span>
...
<div width="100%">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=soft&height=100&section=header&reversal=false&text=Skills%20%2F%20Agents&fontSize=70&fontColor=FFFFFF&fontAlign=50&fontAlignY=50&stroke=-&descSize=20&descAlign=50&descAlignY=50&theme=gruvbox_light"  />
</div>
...
<div width="100%">
  <div>
    <span>🤖</span>
    <span><a href="https://github.com/DiegoLibonati/jira-user-story-from-commit">Jira User Story From Commit</a></span>
    <span>Agent skill that turns staged git changes or a commit into a Jira user story, then creates the issue only after you approve the draft.</span>
  </div>
</div>
